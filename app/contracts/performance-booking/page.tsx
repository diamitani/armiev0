...
const contractData = {
  ...
  tags: ["performance", "booking", "venue", "live", "event"],
  keyTerms: [
    "Performance date, time, and venue details",
    "Artist fee and payment schedule",
    "Technical requirements and rider",
    "Cancellation and force majeure clauses",
    "Sound check and rehearsal provisions",
    "Merchandise and recording rights",
    "Liability and insurance requirements",
    "Hospitality and accommodation terms",
  ],
  prosAndCons: {
    pros: [
      "Clear performance terms and expectations",
      "Standard industry payment structures",
      "Comprehensive technical rider provisions",
      "Built-in cancellation protections",
      "Flexible for various venue types",
    ],
    cons: [
      "May require venue-specific modifications",
      "Technical requirements can be complex",
      "Weather/outdoor event considerations needed",
      "Insurance requirements may vary by location",
    ],
  },
  content: `PERFORMANCE BOOKING AGREEMENT

This Performance Agreement ("Agreement") is entered into on ________ ("Effective Date") between:
...
PERFORMANCE DETAILS:
Date: ________
Time: ________ (Load-in) / ________ (Sound Check) / ________ (Performance)
Venue: ________
Address: ________
Capacity: ________
...
Payment Schedule: ________ due upon signing, ________ due day of performance
Additional Expenses: ________

TECHNICAL REQUIREMENTS:
Sound System: ________
Lighting: ________
Stage Dimensions: ________
...
Artist agrees to perform for approximately ______ minutes.
Performance shall consist of ______ sets with ______ minute intermission.

2. PAYMENT TERMS
Venue shall pay Artist the agreed performance fee.
Payment due: 50% upon signing, 50% on performance date.

3. CANCELLATION
Either party may cancel with ______ days written notice.
Cancellation fees: ________

4. TECHNICAL RIDER
Venue shall provide technical requirements as specified in attached rider.
Sound check time: ________ prior to performance.

5. MERCHANDISE
Artist may sell merchandise at venue.
Venue commission: _______%
...
VENUE: _________________ Date: _______`,
}

export default function PerformanceBookingContractPage() {
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid gap-4 md:grid-cols-3">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">Specify venue, date, and performance requirements</p>
              </div>
              <div className="text-center">
                <DollarSign className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                <h4 className="font-semibold mb-1">Payment Terms</h4>
                <p className="text-sm text-muted-foreground">Set performance fee and payment schedule</p>
              </div>
              <div className="text-center">
                <Users className="h-8 w-8 text-purple-600 mx-auto mb-2" />
                <h4 className="font-semibold mb-1">Technical Rider</h4>
                <p className="text-sm text-muted-foreground">Define sound, lighting, and stage requirements</p>
              </div>
            </div>
          </CardContent>
        </Card>
